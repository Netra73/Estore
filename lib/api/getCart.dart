...
Future<List<Product>> getCartProduct(String cart) async {
  ...
  //https://www.mipa.mu/estore/TEST_API/Products/cartProduct
  HttpClient httpClient = new HttpClient();
  HttpClientRequest request = await httpClient.postUrl(Uri.parse(API_URL+'Cart'));
