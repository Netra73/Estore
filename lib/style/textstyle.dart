...
class mainStyle {
  ...
  static const  Color bgColor = Color(0xffecf0f5);
  static const  Color lightblue= Color(0xffb6d0e2	);
//F5F2F4
  static const  Color bgnewColor = Color(0xf5f2f4);
  static const TextStyle text18Rate = TextStyle(
  ...
  static const TextStyle text14 = TextStyle(
      ...
      fontSize: 14.0,
      fontFamily: 'Arial');
  static const TextStyle promotext14 = TextStyle(
      color: Colors.amber,
      fontSize: 14.0,
      fontFamily: 'Arial');
  static const TextStyle text14White = TextStyle(
      ...
      fontSize: 14.0,
      fontFamily: 'Arial');
  static const TextStyle text14Selected = TextStyle(
      color: secColor,
      fontSize: 14.0,
