        ...
        child: Container(
          ...
          flickManager: flickManager
              ...
              Padding(
                ...
                child: Text("Relative Products",style: mainStyle.text18,),
              ),
              ...
              Container(
                ...
                child: SingleChildScrollView(
                  controller: _scrollController,
                  child: vpList.length == 0 ? FutureBuilder<List<Product>>(
                    future:getVideoRelatedProducts(vid),
                    builder: (context, snapshot) {
                      if (snapshot.connectionState == ConnectionState.waiting) {
                        return SpinKitDoubleBounce(
                          ...
                          Row(
                            ...
                            children: [
                              GestureDetector(
                                onTap: (){
                                  Navigator.push(context, MaterialPageRoute(
                                      builder: (context) =>ImageView(vpList[i].thumb)
                                  ));
                                },
                                child: Hero(
                                  tag : vpList[i].thumb,
                              ...
                              Expanded(
                                child: Container(
                                  child: Column(
                                    ...
                                    children: [
                                      SizedBox(height: 5,),
                                      Text(vpList[i].title, style: mainStyle.text16,),
                                      Text(vpList[i].size, style: mainStyle.text12,),
                                      SizedBox(height: 5,),
                                      Container(
                                        child: Row(
                                          ...
                                          children: [
                                            Row(
                                              children: [
                                                ...
                                                if(offer>0)
                                                  Text(' \u20B9'+vpList[i].rate, style: TextStyle(color: mainStyle.textColor,fontSize: 14,decoration: TextDecoration.lineThrough),),
                                              ],
                                            ),
                                            RaisedButton(
                                              onPressed: (){
